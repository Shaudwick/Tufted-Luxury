...
const RENTAL_PIECES = {
  ...
  sunCard: {
    ...
    description: "Framed hand-tufted Sun Card — smaller scale, same studio craft for intimate spaces.",
  },
  magician: {
    id: "magician",
    title: "The Magician",
    ...
    description: "Framed hand-tufted Magician — a focused accent piece for tablescapes and lounges.",
  },
};
